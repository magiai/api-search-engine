...
export const SmithsonianInstitutionArtDesign = (): JSX.Element => {
    ...
    const getArtworksPictures = useMemo(() => {
        console.log(artworks?.filter(artwork => artwork.content.descriptiveNonRepeating.online_media !== undefined))
        return artworks?.filter(artwork => artwork.content.descriptiveNonRepeating.online_media !== undefined)
        ...
        >
            <Suspense fallback={<p>Loading...</p>}>
                <ArtworksValidation 
                    ...
                    hasArtworks = {getArtworksPictures?.length > 0}
                >
